...
// ========================================================
 ...
 //		echo json_encode($data);
	...
	public function cursos_2022_1S_24()
	{
	  $this->load->view('cursos/2022-1S-24');
	}

	public function cursos_2022_1S_24_1()
	{
	  $this->load->view('cursos/2022-1S-24-1');
	}
	public function cursos_2022_1S_24_2()
	{
	  $this->load->view('cursos/2022-1S-24-2');
	}
...
//Cursos de las Araeas de nivelacions
	...
	// Carrera de tecnología de la Información 2023
	public function cursos_2023_2S_24()
	{
	...
	public function docentes_2023_2S_19()
	{
	  $this->load->view('cursos/docentes-2023-2S-19');
	}



	public function distributivo_2023_2S_19()
	{
	  $this->load->view('cursos/distributivo-2023-2S-19');
	}
 ...
 public function distributivo_2024_1S_20()
	...
	public function trabajos_2023_2S_19()
	{
	  $this->load->view('cursos/trabajos-2023-2S-19');
	}

	public function portafolio_2023_2S_19()
	{
	  $this->load->view('cursos/portafolio-2023-2S-19');
	}
