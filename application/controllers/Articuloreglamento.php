...
function articuloreglamento_data()
{
		...
		foreach($data0->result() as $r){
			$data[]=array($r->idarticuloreglamento,$r->elreglamento,$r->numero,$r->titulo,$r->contenido,
...
$data['reglamentos']= $this->reglamento_model->lista_reglamentos()->result();
  ...
  $this->load->view('articuloreglamento_record',$data);
	...
	public function articuloreglamento_286()
	{
	  $this->load->view('reglamentos/articuloreglamento-286');
	}
