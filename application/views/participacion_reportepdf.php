...
class ReporteParticipacionPDF
{
    ...
    private function initializePdf()
    {
        ...
        // AddPage() will automatically call Header() now
        $this->pdf->AddPage('L'); 
    }
    ...
    /**
     * This method is removed as its logic is moved to PDF::Header()
     ...
     * (No significant changes here, other than the removal of generateTableHeader call)
     */
     ...
     * (Modified to pass sesionEventos and sesionTotal to PDF object)
     */
    public function generateReport(
        ...
        // Assign sesionEventos and sesionTotal to the PDF object properties
        $this->pdf->sesionEventos = $sesionEventos;
        $this->pdf->sesionTotal = $sesionTotal;

        // generateTableHeader() is removed as its logic is now in PDF::Header()
        // $this->generateTableHeader($sesionEventos, $sesionTotal); // REMOVE THIS LINE
