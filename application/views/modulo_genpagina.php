...
$data=$data.'</div>
	    ...
	    <div>  <b style="text-transform:uppercase;text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5); font-size:24px;  color:#333;  margin-top:10px;">Módulo:</b></br>'.$row->nombre.' </div>';	
...
';
			...
			$file='application/views/web/modulossica.php';
