	...
	if(correopara != ''){
		var certi= 'hola' ;
		 ...
		 var nome="Ing. Stalin Francis"; 		
                 var msg="<div style='text-align:center; border-radius:25px; border:2px solid #73AD21; padding:10px;'> Estimado/a <b>"+ $(this).data('lapersona')+"</b> ,  Tus documentos estan siendo guadados y clasificados en la plataforma Cloud de la Carrera en Tecnología de la Información. Puedes  acceder a la plataforma utilizando el siguiente enlace <a href='"+"https://educaysoft.org/sica/login"+"'>Login</a>.<br><br> Tu usuario es :<b>"+$(this).data('email')+"</b><br> Tu contraseña es :<b> "+$(this).data('password')+"</b><br><br> Con estas credenciales podrás acceder a tu portafolio. <br> Te informamos que tu portafolio esta siendo actualizado frecuentemente con los documentos que entregas o recibes en la Dirección de la Carrera en Tecnología de la Información</br> Puedes  desacargar los documentos directamente ingersando a la plataforma</div>" ;
