...
<main>
		...
		<img src="https://repositorioutlvte.org/Repositorio/qr/documento-109-109.png" height="150px">
		</div>
      		<div >
        	<p class="lead text-muted">Tipo de documento</p>
        	<h1 class="fw-light">109</h1>  
        	<p style="font-size:2em; color:#6c757d;text-shadow: 1px 1px 2px #000, -1px -1px 2px #fff;">LIBROS RED-EDUCAYSOFT</p>
      		</div>
    		</div>
  		</section>
		  ...
		  <svg class="bd-placeholder-img card-img-top" width="100%" height="225" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#55595c"/><image  class="thumbnail" href="https://repositorioutlvte.org/Repositorio/portadas/2025-04-01-YIT-02767.jpg" alt="No hay programación" height="100%" width="100%"  onclick="mostrarImagen('https://repositorioutlvte.org/Repositorio/portadas/2025-04-01-YIT-02767.jpg')" /> </svg>
<div class="img-contenedor w3-card-4" style="position:absolute"; top:0px;right:0px; border: 2px solid green; border-radius: 50%; width: 30%; display:flex; justify-content: center; align-items: center;"></div>
...
<div class="mb-3">
        ...
        <span class="text-success fw-bold text-shadow"><?= htmlspecialchars("2767") ?></span>
    </div>
 <div class="mb-3">
        <h5 class="text-primary">Nombre:</h5>
        <span class="text-secondary fw-bold text-shadow"><?= htmlspecialchars("Fundamentals of Image Processing") ?></span>
    </div>

<div class="mb-3">
        <h6 class="text-dark"><b>Autor:</b></h6>
        <p class="mb-0"><?= htmlspecialchars("Young  Ian T. ") ?></p>
    </div>


        <div > 
        <h6 class="text-dark"><b>Archivo:</b></h6>
         <a href="https://repositorioutlvte.org/Repositorio/2025-04-01-YIT-02767.pdf" class="btn btn-outline-primary btn-sm" target="_blank">  Descargar Archivo</a> </div><div class="d-flex justify-content-between align-items-center">
