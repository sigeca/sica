...
<main>
		...
		<img src="https://repositorioutlvte.org/Repositorio/qr/documento-10-10.png" height="150px">
		</div>
      		<div >
        	<h1 class="fw-light">10</h1>  
        	<p class="lead text-muted">Institución:10 :: 10.</p>
        	<p style="font-size:2em; color:#6c757d;text-shadow: 1px 1px 2px #000, -1px -1px 2px #fff;">Documentos :Guia de Aprendizaje</p>
      		</div>
    		</div>
  		</section>
		  ...
		  <svg class="bd-placeholder-img card-img-top" width="100%" height="225" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#55595c"/><image href="https://repositorioutlvte.org/Repositorio/documento/documento0.jpg" alt="No hay programación" height="100%" width="100%"/> </svg>
    <div class="img-contenedor w3-card-4" style="position:relative; width:100%; height:100%; display:flex; justify-content: center; align-items: center;"> <input type="file" id="fileInput80" accept="image/*">
  <button onclick="uploadImage('documento80.jpg','80')">Subir Imagen</button>
  <p id="status80"></p> </div>
        ...
        <div style="font-size:20px;  color:#333;  margin-top:10px;" > <b>Cóðigo:</b><br> <span  style="color:#6c757d;text-shadow: 1px 1px 2px #000, -1px -1px 2px #fff;" >80 </span></div>
        <div style="font-size:20px;  color:#333;  margin-top:10px;" > <b>::Nombre :</b><br> <span  style="color:#6c757d;text-shadow: 1px 1px 2px #000, -1px -1px 2px #fff;" >GUÍA DE APRENDIZAJE DE LA ASIGNATURA FUNDAMENTOS DE PROGRAMACIÓN</span> </div>
        <div style="font-size:14px;  color:#333;  margin-top:10px;" ><b>Autor:</b><br>  </div>
        <div style="font-size:14px;  color:#333;  margin-top:10px;" ><b> Archivo:</b>  <a href="https://repositorioutlvte.org/Repositorio/2022-02-01-FQSA-000080.pdf"> 2022-02-01-FQSA-000080.pdf</a> </div><div class="d-flex justify-content-between align-items-center">
...
<div class="col">
          <div class="card shadow-sm">
		  <svg class="bd-placeholder-img card-img-top" width="100%" height="225" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#55595c"/><image href="https://repositorioutlvte.org/Repositorio/documento/documento0.jpg" alt="No hay programación" height="100%" width="100%"/> </svg>
    <div class="img-contenedor w3-card-4" style="position:relative; width:100%; height:100%; display:flex; justify-content: center; align-items: center;"> <input type="file" id="fileInput209" accept="image/*">
  <button onclick="uploadImage('documento209.jpg','209')">Subir Imagen</button>
  <p id="status209"></p> </div>
        ...
        <div class="card-body" style="background-color:red"  >
        <div style="font-size:20px;  color:#333;  margin-top:10px;" > <b>Cóðigo:</b><br> <span  style="color:#6c757d;text-shadow: 1px 1px 2px #000, -1px -1px 2px #fff;" >209 </span></div>
        <div style="font-size:20px;  color:#333;  margin-top:10px;" > <b>::Nombre :</b><br> <span  style="color:#6c757d;text-shadow: 1px 1px 2px #000, -1px -1px 2px #fff;" >GUIA PARA WEBINAR SOBRE GITHUB Y LATEX</span> </div>
        <div style="font-size:14px;  color:#333;  margin-top:10px;" ><b>Autor:</b><br> Francis Quinde Stalin Adalberto </div>
        <div style="font-size:14px;  color:#333;  margin-top:10px;" ><b> Archivo:</b>  <a href="https://repositorioutlvte.org/Repositorio/2022-05-04-FQSA-00209.pdf"> 2022-05-04-FQSA-00209.pdf</a> </div><div class="d-flex justify-content-between align-items-center">
...
<div class="col">
          <div class="card shadow-sm">
		  <svg class="bd-placeholder-img card-img-top" width="100%" height="225" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#55595c"/><image href="https://repositorioutlvte.org/Repositorio/documento/documento0.jpg" alt="No hay programación" height="100%" width="100%"/> </svg>
    <div class="img-contenedor w3-card-4" style="position:relative; width:100%; height:100%; display:flex; justify-content: center; align-items: center;"> <input type="file" id="fileInput206" accept="image/*">
  <button onclick="uploadImage('documento206.jpg','206')">Subir Imagen</button>
  <p id="status206"></p> </div>
        ...
        <div class="card-body" style="background-color:red"  >
        <div style="font-size:20px;  color:#333;  margin-top:10px;" > <b>Cóðigo:</b><br> <span  style="color:#6c757d;text-shadow: 1px 1px 2px #000, -1px -1px 2px #fff;" >206 </span></div>
        <div style="font-size:20px;  color:#333;  margin-top:10px;" > <b>::Nombre :</b><br> <span  style="color:#6c757d;text-shadow: 1px 1px 2px #000, -1px -1px 2px #fff;" >MANUAL METODOLOGÍA DE LA INVESTIGACIÓN PARA TITULACIÓN</span> </div>
        <div style="font-size:14px;  color:#333;  margin-top:10px;" ><b>Autor:</b><br> Francis Quinde Stalin Adalberto </div>
        <div style="font-size:14px;  color:#333;  margin-top:10px;" ><b> Archivo:</b>  <a href="https://repositorioutlvte.org/Repositorio/2022-05-03-FQSA-00206.pdf"> 2022-05-03-FQSA-00206.pdf</a> </div><div class="d-flex justify-content-between align-items-center">
