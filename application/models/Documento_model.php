...
class Documento_model extends CI_model {
  ...
  public function get_documentos($idtipodocu) {
        ...
        $query = $this->db->get('documento'); // Suponiendo que la tabla se llama 'documentos'
	...
	//Retorna todos los registros como un objeto
	function documentosxtipo($idtipodocumento,$asunto){
	...
	//Retorna todos los registros como un objeto
	function lista_documentosreci($idpersona){
...
// Para moverse al anterior registro
	...
	function emisores( $iddocu)
	{
		...
		$emisores=$this->db->query('select idpersona,elemisor,idemisor from emisor1 where iddocumento="'. $iddocu.'"');
		return $emisores;
	}
